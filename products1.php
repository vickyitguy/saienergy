...
<body>
    ...
    margin-top: 86px;">
                            ...
                            <li>Strainers, etc.</li>
                              ...
                              <h5>Water Treatment Plant and Boiler Chemicals</h5>
                               ...
                               <li>DM plant chemicals – Morpholine,Caustic soda Flakes and HCL</li>
                               <li>Pre Treatment chemicals – Ferric chloride, Lime, Cationic polymer, Hypo, Alum, and SMB</li>
                ...
                <div class="grid_4" style="padding-top:77px;">
                            ...
                            <li>ESP</li>
                            <li>Spares for Water Treatment plants</li>
    ...
    <img src="images/drum1.png" style="border:1px solid rgba(119, 117, 117, 0.11);width: 398px;
    margin-top: 86px;">
